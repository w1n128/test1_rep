  ...
  function drawPaused() {
    ...
    const rules = [
      ...
      },
      {
        type: 'firecracker',
        name: 'Петарда',
        desc: 'Фитиль 1.5 сек, взрыв в радиусе 1.5 тайла, урон 1. До 3 в инвентаре.',
      },
      {
        type: 'trapdoor',
        name: 'Люк',
        desc: 'Невидим противнику. Проваливает на 2 сек, без управления. До 3 в инвентаре.',
      },
      {
        type: 'banana',
        name: 'Банановая кожура',
        desc: 'Бросок на 3 тайла вперёд. Скольжение мгновенно, без подготовки. До 3 в инвентаре.',
      },
    ];
